...
新增「天际 → 板块 → 气候 → 生态 → 地表」五级观察入口和 0–100% 缩放进度。大洋增加七组岛弧；薄云、板块名称、雨云气流、水系山林与地表细节在前 80% 缩放中连续展开。气候层包含 2,320 条 GPU 动画粒子、风格化云层 Shader 和海洋流场高光。远景山体压低，近景恢复完整起伏。地貌继续使用靛蓝海洋、青绿森林、赤铜山体和冷白冰川配色，局部细分跟随观察位置。
