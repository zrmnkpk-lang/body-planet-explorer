...
新增「天际 → 板块 → 气候 → 生态 → 地表」五级观察入口和 0–100% 缩放进度。大洋增加七组岛弧；薄云、板块名称、雨云气流、水系山林与地表细节在前 80% 缩放中连续展开。气候层包含 2,320 条 GPU 动画粒子、风格化云层 Shader 和海洋流场高光。远景山体压低，近景恢复完整起伏。七处主要大陆均有宽缓的连续山势与高原，深青森林在远景呈片状林带、近景展开为针叶树实例。地貌使用靛蓝海洋、青绿森林、赤铜岩层和冷白冰川配色，局部细分跟随观察位置。
